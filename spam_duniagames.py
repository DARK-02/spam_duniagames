...
if __name__ == '__main__':
    for i in range(int(jumlah)):
        ...
        if 'Field ini harus diisi dengan nomor Telkomsel' in darko:
             print ('  \033[31m➤ \033[1;37mNo Target Harus Menggunakan Telkomsel! \033[31m ')
             time.sleep(2)
             print ('  \033[31m➤ \033[1;37mUntuk Sementara Belum Tersedia Untuk Sim yg lain! \033[31m ')
             time.sleep(1)
             print (" \033[1;30m<═════════════════════════════════════════════>")
             break
        if 'Maaf, Anda belum melakukan konfirmasi OTP di transaksi sebelumnya, silakan coba kembali setelah 1 menit' in darko:
             print ('  \033[31m➤ \033[1;37mTidak dapat terkirim di karenakan inquiryId sedang di gunakan!, ganti inquiryId dengan yang baru! \033[31m ')
        else:
             print ('  \033[31m➤ \033[1;37mTerkirim \033[31m ')
